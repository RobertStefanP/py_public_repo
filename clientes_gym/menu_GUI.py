...
class App(tk.Tk):
    ...
    def mostrar_formulario(self):
        """Creamos el frame para introducir datos en la base de datos."""
    ...
    def guardar_cliente(self):
        """Guardamos un nuevo cliente en la base de datos."""
        ...
        # Validamos el valor del atributo self.id_cliente
    ...
    def eliminar_cliente(self):
        ...
        if self.id_cliente is None:
            ...
            showinfo(title="Eliminado", message="Clienete eliminado ...")
            self.recargar_datos()
